...
@section('content')
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- registration inputs --> 
            <div class="card-body">
                <form action="{{ route('front.online_occurrence.apply', $occurrence) }}" method="POST">
                    @csrf
                    <!-- personal details -->
...
<input type="text" class="form-control"  hidden="" name="extra" id="extra" value="{{$extra}}">
                     ...
                     <div class="form-row">
                          <!--     <div class="form-group col-md-12 " >
                                <small class="form-text text-muted" style="display: none">Invoice* </small>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="invoice" id="individual" value="individual" hidden="" 
                                        @if (old('invoice', 'individual') == 'individual')
                                            checked 
                                        @endif>
                                    <label class="form-check-label" style="display: none">Invoice Individual</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="invoice" id="organisation" value="organization" hidden="" 
                                        @if (old('invoice', 'individual') == 'organization')
                                            checked 
                                        @endif>
                                    <label class="form-check-label" style="display: none">Invoice Organisation</label>
                                </div>
                            </div>
                             <div class="form-group col-md-12">
