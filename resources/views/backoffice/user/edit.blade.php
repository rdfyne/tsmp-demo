@extends('backoffice.master', ['title' => 'Edit User'])
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="d-flex flex-column-fluid">
			...
			<div class="container">
				...
				<form class="card form" action="{{ route('backoffice.user.update', $user) }}" method="POST">
					@csrf
					@method('PUT')
					<div class="card-body">
						<div class="form-group row mt-4">
							...
							<div class="col-9">
								<input type="text" name="name" class="form-control form-control-solid" placeholder="Enter Full Name" value="{{ old('name', $user->name) }}" />
						...
						<div class="form-group row mt-4">
							...
							<div class="col-9">
								<input type="email" name="email" class="form-control form-control-solid" placeholder="Enter Email" value="{{ old('email', $user->email) }}" />
