@extends('backoffice.master', ['title' => 'Add Course'])
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="d-flex flex-column-fluid">
			...
			<div class="container">
				...
				<!--begin::Card-->
				<form class="card form" id="course-form" action="{{ route('backoffice.course.store') }}" method="POST" @submit="save" enctype="multipart/form-data">
					@csrf
					<div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="number" class="form-control" placeholder="Position" name="position" value="{{ old('position') }}" required />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-line">
                        ...
                        <div class="form-group">
                            ...
                            @if ( old('enable_online_booking') == "checked")
                                checked
                            @endif>
                        ...
                        @if ( old('enable_online_booking') !== "checked")
                            style="display: none"
                        @endif>
                            <h4>Set Virtual  Online Classes</h4>
                        ...
                        <!-- End Online Occurrence -->
                        <!-- Dates -->
                        <h4>Classrom  classes </h4>
